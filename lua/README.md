...
The Lua SDK for the DnsLookup API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/dns-lookup-sdk/releases)),
...
```lua
local sdk = require("dns-lookup_sdk")
...
```
lua/
├── dns-lookup_sdk.lua    -- Main SDK module
...
The main module (`dns-lookup_sdk`) exports the SDK constructor
