...
// DnsLookup SDK clienttrack feature
...
class DnsLookupClienttrackFeature extends DnsLookupBaseFeature
{
    ...
    public function PostConstruct(DnsLookupContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DnsLookup-SDK';
