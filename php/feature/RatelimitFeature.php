...
// DnsLookup SDK ratelimit feature
...
class DnsLookupRatelimitFeature extends DnsLookupBaseFeature
{
    ...
    private function _acquire(DnsLookupContext $ctx): void
    {
    ...
    private function _track(DnsLookupContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
