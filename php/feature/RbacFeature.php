...
class DnsLookupRbacFeature extends DnsLookupBaseFeature
{
    ...
    private function _required(DnsLookupContext $ctx): ?string
    {
    ...
    private function _reject(DnsLookupContext $ctx, string $required): void
    {
    ...
    private function _track(DnsLookupContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
