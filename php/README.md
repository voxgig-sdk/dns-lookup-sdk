...
The PHP SDK for the DnsLookup API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'dnslookup_sdk.php';

$client = new DnsLookupSDK([
    "apikey" => getenv("DNS_LOOKUP_APIKEY"),
]);
```
...
```php
require_once 'dnslookup_sdk.php';
$client = new DnsLookupSDK($options);
```
...
```
php/
├── dnslookup_sdk.php          -- Main SDK class
...
The main class (`dnslookup_sdk.php`) exports the SDK class
