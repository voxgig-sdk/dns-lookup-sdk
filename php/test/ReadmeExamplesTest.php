...
// DnsLookup SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DnsLookupSDK::test)
...
{
    private const SDK_CLASS = 'DnsLookupSDK';
    ...
    private const SDK_BASE = 'dnslookup_sdk';
