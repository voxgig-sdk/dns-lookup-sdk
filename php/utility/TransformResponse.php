...
// DnsLookup SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DnsLookupTransformResponse
{
    public static function call(DnsLookupContext $ctx): mixed
    {
        ...
        $transform = DnsLookupHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
