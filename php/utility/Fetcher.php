...
// DnsLookup SDK utility: fetcher

class DnsLookupFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DnsLookupSDK/1.0)';
    ...
    public static function call(DnsLookupContext $ctx, string $fullurl, array $fetchdef): array
    {
