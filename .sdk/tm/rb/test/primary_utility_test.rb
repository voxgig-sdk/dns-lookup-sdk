...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = DnsLookupOmni.make_runner(TEST_JSON_FILE, DnsLookupSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : DnsLookupOmni.errify(err)
    end
