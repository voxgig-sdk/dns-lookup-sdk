...
class DnsLookupGraphql
{
    ...
    // equivalent.
    public static function body(DnsLookupContext $ctx): mixed
    {
    ...
    public static function errors(DnsLookupContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
