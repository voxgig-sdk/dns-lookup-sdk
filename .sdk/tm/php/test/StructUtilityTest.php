...
// DnsLookup SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DnsLookupOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DnsLookupOmni::structfix($now, Struct::undef()))
                        !== json_encode(DnsLookupOmni::structfix($val, Struct::undef()))) {
