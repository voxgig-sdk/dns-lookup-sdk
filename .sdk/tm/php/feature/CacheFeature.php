...
class DnsLookupCacheFeature extends DnsLookupBaseFeature
{
    ...
    private function _through(DnsLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
