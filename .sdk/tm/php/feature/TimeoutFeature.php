...
class DnsLookupTimeoutFeature extends DnsLookupBaseFeature
{
    ...
    private function _with_timeout(DnsLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DnsLookupContext $_ctx, float $ms): void
    {
        $client = $this->client;
