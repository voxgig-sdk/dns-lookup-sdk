...
// DnsLookup SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DnsLookupTestFeature extends DnsLookupBaseFeature
{
    ...
    public function init(DnsLookupContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DnsLookupContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DnsLookupParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DnsLookupContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DnsLookupContext $ctx, $op, $args): array
    {
