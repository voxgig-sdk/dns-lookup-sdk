...
// DnsLookup SDK streaming feature
...
class DnsLookupStreamingFeature extends DnsLookupBaseFeature
{
    ...
    private function _iterate(DnsLookupResult $result): \Generator
    {
    ...
    private function _streamable(DnsLookupContext $ctx): bool
    {
