...
class DnsLookupProxyFeature extends DnsLookupBaseFeature
{
    ...
    public function init(DnsLookupContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DnsLookupContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
