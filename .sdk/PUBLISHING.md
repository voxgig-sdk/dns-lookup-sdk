...
|---|---|---|
| `ts/` | @voxgig-sdk/dns-lookup-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dns-lookup-sdk \
      --repository voxgig-sdk/dns-lookup-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dns-lookup-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dns-lookup-sdk --id=<id>` removes it.
