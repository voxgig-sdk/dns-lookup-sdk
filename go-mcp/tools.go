...
func registerTools(server *mcp.Server, client *sdk.DnsLookupSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dns-lookup_list",
		Description: "List records from DnsLookup. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dns-lookup_load",
		Description: "Load a single record from DnsLookup. " +
...
func runOp(client *sdk.DnsLookupSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DnsLookupSDK, name string) (sdk.DnsLookupEntity, error) {
