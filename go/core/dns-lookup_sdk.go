...
import (
	...
	vs "github.com/voxgig-sdk/dns-lookup-sdk/go/utility/struct"
)

type DnsLookupSDK struct {
	Mode     string
...
func (sdk *DnsLookupSDK) OptionsMap() map[string]any {
...
func (sdk *DnsLookupSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DnsLookupSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DnsLookupSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DnsLookupSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DnsLookupSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DnsLookupSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DnsLookupSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DnsLookupSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DnsLookupSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DnsLookupSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *DnsLookupSDK) DnsResult(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Domain(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) EmailValidate(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Generate(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Grammar(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Ipn(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Redact(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Ssl(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Utility(data map[string]any) DnsLookupEntity {
...
func (sdk *DnsLookupSDK) Whoi(data map[string]any) DnsLookupEntity {
