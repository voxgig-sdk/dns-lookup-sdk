# DnsLookup Golang SDK Reference

Complete API reference for the DnsLookup Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *DnsLookupSDK`
