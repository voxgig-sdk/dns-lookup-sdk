# DnsLookup Golang SDK



The Golang SDK for the DnsLookup API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/dns-lookup-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/dns-lookup-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/dns-lookup-sdk/go=../dns-lookup-sdk/go
```
...
import (
    "fmt"
    "os"
    sdk "github.com/voxgig-sdk/dns-lookup-sdk/go"
)

func main() {
    client := sdk.NewDnsLookupSDK(map[string]any{
        "apikey": os.Getenv("DNS_LOOKUP_APIKEY"),
    })
...
```
DNS_LOOKUP_TEST_LIVE=TRUE
DNS_LOOKUP_APIKEY=<your-key>
```
...
```go
func NewDnsLookupSDK(options map[string]any) *DnsLookupSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DnsLookupSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### DnsLookupSDK methods
...
| `DnsResult` | `(data map[string]any) DnsLookupEntity` | Create a DnsResult entity instance. |
| `Domain` | `(data map[string]any) DnsLookupEntity` | Create a Domain entity instance. |
| `EmailValidate` | `(data map[string]any) DnsLookupEntity` | Create an EmailValidate entity instance. |
| `Generate` | `(data map[string]any) DnsLookupEntity` | Create a Generate entity instance. |
| `Grammar` | `(data map[string]any) DnsLookupEntity` | Create a Grammar entity instance. |
| `Ipn` | `(data map[string]any) DnsLookupEntity` | Create an Ipn entity instance. |
| `Redact` | `(data map[string]any) DnsLookupEntity` | Create a Redact entity instance. |
| `Ssl` | `(data map[string]any) DnsLookupEntity` | Create a Ssl entity instance. |
| `Utility` | `(data map[string]any) DnsLookupEntity` | Create an Utility entity instance. |
| `Whoi` | `(data map[string]any) DnsLookupEntity` | Create a Whoi entity instance. |

### Entity interface (DnsLookupEntity)

All entities implement the `DnsLookupEntity` interface.
...
```
github.com/voxgig-sdk/dns-lookup-sdk/go/
├── dns-lookup.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/dns-lookup-sdk/go`) re-exports everything needed
