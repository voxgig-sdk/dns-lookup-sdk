...
declare class DnsLookupSDK {
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): DnsLookupSDK;
    tester(testopts?: any, sdkopts?: any): DnsLookupSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof DnsLookupSDK;
export { stdutil, config, BaseFeature, DnsLookupEntityBase, DnsLookupSDK, SDK, };
