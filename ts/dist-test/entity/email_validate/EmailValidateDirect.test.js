...
(0, node_test_1.describe)('EmailValidateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DnsLookupSDK({
...
function liveScenariosActive() { return false && process.env.DNS_LOOKUP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'DNS_LOOKUP_TEST_EMAIL_VALIDATE_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.DnsLookupSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.DNS_LOOKUP_APIKEY,
        }));
        let idmap = env['DNS_LOOKUP_TEST_EMAIL_VALIDATE_ENTID'];
    ...
    const client = new __1.DnsLookupSDK({
        base: 'http://localhost:8080',
