...
(0, node_test_1.describe)('EmailValidateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set DNS_LOOKUP_TEST_EMAIL_VALIDATE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['DNS_LOOKUP_TEST_EMAIL_VALIDATE_ENTID'];
    ...
    idmap = env['DNS_LOOKUP_TEST_EMAIL_VALIDATE_ENTID'];
