# DnsLookup TypeScript SDK Reference

Complete API reference for the DnsLookup TypeScript SDK.
...
```ts
new DnsLookupSDK(options?: object)
```
...
#### `DnsLookupSDK.test(testopts?, sdkopts?)`
...
**Returns:** `DnsLookupSDK` instance in test mode.
...
Return the parent `DnsLookupSDK` instance.
