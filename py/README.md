# DnsLookup Python SDK



The Python SDK for the DnsLookup API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/dns-lookup-sdk/releases)) or
...
client = DnsLookupSDK({
    "apikey": os.environ.get("DNS_LOOKUP_APIKEY"),
})
```
...
```
py/
├── dnslookup_sdk.py         -- Main SDK module
