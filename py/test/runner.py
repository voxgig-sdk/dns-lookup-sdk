...
class DnsLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DnsLookupTestRunner.getenv("DNSLOOKUP_TEST_LIVE")
        override = DnsLookupTestRunner.getenv("DNSLOOKUP_TEST_OVERRIDE")
        ...
        explain = DnsLookupTestRunner.getenv("DNSLOOKUP_TEST_EXPLAIN")
