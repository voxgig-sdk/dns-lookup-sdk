...
class DnsLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DnsLookupTestRunner.getenv("DNS_LOOKUP_TEST_LIVE")
        override = DnsLookupTestRunner.getenv("DNS_LOOKUP_TEST_OVERRIDE")
        ...
        explain = DnsLookupTestRunner.getenv("DNS_LOOKUP_TEST_EXPLAIN")
