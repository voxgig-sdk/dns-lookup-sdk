# DnsLookup SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DnsLookupSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DnsLookupSDK(...) and DnsLookupSDK.test(...) become
#      DnsLookupSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dnslookup_sdk"
_SDK_CLASS = "DnsLookupSDK"
