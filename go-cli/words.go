...
func registerSDKWords(r *eng.Registry, client *sdk.DnsLookupSDK) {
...
func runOp(client *sdk.DnsLookupSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
